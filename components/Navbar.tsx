      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 md:h-20 gap-2">
          <div className="flex items-center shrink-0">
            <Link to="/" className="flex items-center gap-3 group">
              <div className="relative">
                ...
                <div className="absolute -bottom-1 -right-1 w-4 h-4 bg-[#FEDD00] rounded-full border-2 border-white shadow-sm flex items-center justify-center"><div className="w-1.5 h-1.5 bg-[#009739] rounded-full"></div></div>
              </div>
          ...
          <div className="flex items-center gap-2 md:gap-4 shrink-0">
            <button onClick={() => navigate('/professional')} className={`px-3 py-2 md:px-5 md:py-2.5 rounded-lg text-[10px] md:text-xs font-black uppercase tracking-widest transition-all border-2 ${isActive('/professional') ? 'bg-[#009739] text-white border-[#009739]' : 'text-[#009739] border-[#009739] hover:bg-[#009739] hover:text-white'}`}>
              <span className="hidden sm:inline">Para Profissionais (BR)</span><span className="sm:hidden">Pro (BR)</span>
            </button>
            <button onClick={() => navigate('/express-match')} className="bg-[#002868] hover:bg-black text-white px-3 py-2 md:px-5 md:py-2.5 rounded-lg text-[10px] md:text-xs font-black uppercase tracking-widest shadow-md transition-all active:scale-95">
              <span className="hidden sm:inline">Express Match</span><span className="sm:hidden">Match</span>
            </button>
