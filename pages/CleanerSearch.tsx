                ...
                return (
                  <div key={cleaner.id} className="bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 flex flex-col overflow-hidden group">
                    ...
                    <div className="h-56 bg-gray-200 relative overflow-hidden">
                      ...
                      {/* Verified Badge & Portfolio Overlay */}
                      <div className="absolute top-4 left-4 flex flex-col gap-2">
                         {cleaner.status === 'VERIFIED' && <span className="bg-white/95 backdrop-blur-sm text-green-700 text-xs font-bold px-3 py-1.5 rounded-full flex items-center gap-1.5 shadow-md border border-white w-fit">
                          ...
                          {approvedPortfolio.length > 0 && (
                             <button onClick={() => setSelectedPortfolio(approvedPortfolio)} className="bg-blue-600 text-white text-[10px] font-black px-3 py-1.5 rounded-full uppercase tracking-wide shadow-sm flex items-center gap-1 hover:bg-blue-700 transition w-fit border border-blue-400">
